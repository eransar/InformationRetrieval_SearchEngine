...
public class newReadFile {
    ...
    public newReadFile(String path,String StopWordsPath,String path_posting,boolean steam) throws IOException {
        this.path = path;
        this.docs = new HashSet<Doc>();
        this.stopWordsPath=StopWordsPath;
        this.parse = new newParser(StopWordsPath,path_posting);
        this.numofDocs=1;
        this.steam = steam;
...
//            newParser.ParseDoc(new Doc(DOCNO, file.getName(),CITY,HEADER,DATE,LANGUAGE), TEXT);
        }
    }
